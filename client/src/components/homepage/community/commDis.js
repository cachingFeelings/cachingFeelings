...
const CommDis = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        const response = await fetch('https://caching-feelings-server.onrender.com/api/community/getPosts', {
          method: 'GET',
          headers: {
  ...
  useEffect(() => {
    ...
    const fetchCurrentUserId = async () => {
      try {
        const response = await fetch('https://caching-feelings-server.onrender.com/api/user/getCurrentUserId', {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + token
  ...
  const handleLike = async (postId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://caching-feelings-server.onrender.com/api/community/likeDislike', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + token
  ...
  const handleDelete = async (postId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://caching-feelings-server.onrender.com/api/community/delete`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + token
  ...
  const handleReport = async (postId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://caching-feelings-server.onrender.com/api/community/report', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + token
  ...
  const handlePostSubmit = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://caching-feelings-server.onrender.com/api/community/newPosts', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + token,
